...
mpdi= (tb11V - tb11H)/(tb11V + tb11H)
vmpdi= (vtb11V - vtb11H)/(vtb11V + vtb11H)
...
dev.copy(postscript, "plot-spatial-parm-a.ps", horizontal=T)
dev.off()
...
dev.copy(postscript, "plot-spatial-parm-b.ps", horizontal=T)
dev.off()
...
dev.copy(postscript, "plot-spatial-parm-c.ps", horizontal=T)
dev.off()
...
dev.copy(postscript, "plot-b-c-corrr.ps", horizontal=T)
dev.off()


# print the numbers
print(paste("MPDI-based 10V=", round(mean(errs[ , , 3]*100), 3)), quote=F)
print(paste("MPDI-based 19V=", round(mean(errs[ , , 5]*100), 3)), quote=F)
print(paste("MPDI-based 37V=", round(mean(errs[ , , 9]*100), 3)), quote=F)
print(paste("MPDI-based 89V=", round(mean(errs[ , , 11]*100), 3)), quote=F)

print("")

print(paste("MPDI-based 10H=", round(mean(errs[ , , 4]*100), 3)), quote=F)
print(paste("MPDI-based 19H=", round(mean(errs[ , , 6]*100), 3)), quote=F)
print(paste("MPDI-based 37H=", round(mean(errs[ , , 10]*100), 3)), quote=F)
print(paste("MPDI-based 89H=", round(mean(errs[ , , 12]*100), 3)), quote=F)
