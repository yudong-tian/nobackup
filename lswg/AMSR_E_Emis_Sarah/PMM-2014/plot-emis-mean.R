...
#  mean emis
image.plot(lon, lat, emis[ , , 1], main="11V", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 3], main="19V", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
#image.plot(lon, lat, emis[ , , 7], main="24V", horizontal=T, zlim=c(0.8, 1),
# axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 7], main="37V", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 9], main="89V", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )

image.plot(lon, lat, emis[ , , 2], main="11H", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 4], main="19H", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
#image.plot(lon, lat, emis[ , , 8], main="24H", horizontal=T, zlim=c(0.8, 1),
# axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 8], main="37H", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
image.plot(lon, lat, emis[ , , 10], main="89H", horizontal=T, zlim=c(0.8, 1),
 axis.args=list(cex.axis=2), cex.axis=2, cex.main=2, xlab="", ylab="" )
...
for (ich in 1:nch) { 
 for (ir in 1:nr ) {
  for (ic in 1:nc ) {
   ...
   avg[ic, ir, ich]=mean(vems[ic, ir, ich, ], na.rm=T)      

  }
 }
}

plot_emis(lon, lat, avg, "mean")
