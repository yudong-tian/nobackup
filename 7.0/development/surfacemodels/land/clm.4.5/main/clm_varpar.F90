...
#endif
  !YDT integer, parameter :: maxpatch_pft= MAXPATCH_PFT ! max number of plant functional types in naturally vegetated landunit
  integer, parameter :: maxpatch_pft= 17 ! max number of plant functional types in naturally vegetated landunit
