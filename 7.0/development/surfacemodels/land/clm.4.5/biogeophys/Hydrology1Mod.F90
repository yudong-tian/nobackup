...
!YDT   public :: Hydrology1_readnl ! Read namelist
...
!YDT xxxxxxxxxxxxxxxxxxxxxxxxx start of turn off xxxxxxxxxxxxxxxxxxxxxxxxxxxxx
#if 0 
!-----------------------------------------------------------------------
!BOP
!
...
#endif
!YDT xxxxxxxxxxxxxxxxxxxxxxxxx end of turn off xxxxxxxxxxxxxxxxxxxxxxxxxxxxx
!-----------------------------------------------------------------------
...
!YDT    use SNICARMod    , only : snw_rds_min
...
!YDT: copied from SNICARMod
  real(r8),  parameter :: snw_rds_min = 54.526_r8 
