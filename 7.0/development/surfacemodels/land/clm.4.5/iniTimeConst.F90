...
! !USES:
  ...
  use clm45_decompMod   , only : gsMap_lnd_gdc2glo
  ...
  use clm45_pftvarcon   , only : noveg, ntree, roota_par, rootb_par,  &
  ...
  use clm45_pftvarcon       , only : fertnitro, graincn, fleafcn, ffrootcn, fstemcn
